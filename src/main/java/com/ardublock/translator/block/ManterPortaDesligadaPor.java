...
/**
 ...
 @author jvbor
 */
public class ManterPortaDesligadaPor extends TranslatorBlock {

    public ManterPortaDesligadaPor(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException, BlockException {
        ...
        ret = "if(digitalRead(" + porta + ")==1){digitalWrite(" + porta + ",0); timer.every(" + tempo + ", [](uint32_t v){ digitalWrite(" + porta + ",1); },1);}";
